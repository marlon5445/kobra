...
<?= $this->section('title') ?>Nuevo Proveedor<?= $this->endSection() ?>
...
<div class="page-header">
    <div>
        <h1 class="page-title">
            <i class="fa-solid fa-truck-ramp-box text-primary"></i> Registrar Proveedor
        </h1>
        <p class="page-subtitle">Añade un nuevo proveedor de mercancía a la base de datos.</p>
    </div>
    <div>
    ...
    <div class="col-12 col-xl-8">
        ...
        <div class="card card-custom border-0 shadow-sm">
            ...
            <div class="card-custom-body">
                ...
                <form action="<?= base_url('proveedores/guardar') ?>" method="POST" autocomplete="off">
                    <?= csrf_field() ?>

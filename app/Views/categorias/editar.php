...
<?= $this->section('title') ?>Editar Categoría<?= $this->endSection() ?>
...
<div class="page-header">
    <div>
        <h1 class="page-title">
            <i class="fa-solid fa-pen-to-square text-primary"></i> Editar Categoría
        </h1>
        <p class="page-subtitle">Modifica la información de la categoría seleccionada.</p>
    </div>
    <div>
        ...
        <div class="card card-custom border-0 shadow-sm">
            <div class="card-custom-header">
                <h5 class="card-custom-title">
                    <i class="fa-solid fa-file-pen text-primary me-2"></i> Editar Registro #<?= esc($categoria['id']) ?>
                </h5>
            </div>
            <div class="card-custom-body">
                ...
                <form action="<?= base_url('categorias/actualizar/' . $categoria['id']) ?>" method="POST" autocomplete="off">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="descripcion" 
                                  ...
                                  style="border-radius: var(--radius-md)"><?= old('descripcion', $categoria['descripcion']) ?></textarea>
                    </div>

...
<div class="page-header">
    <div>
        <h1 class="page-title">
            <i class="fa-solid fa-user-plus text-primary"></i> Registrar Cliente
        </h1>
        <p class="page-subtitle">Añade un nuevo cliente a la base de datos para facturación y ventas.</p>
    </div>
    <div>
    ...
    <div class="col-12 col-xl-8">
        ...
        <div class="card card-custom border-0 shadow-sm">
            ...
            <div class="card-custom-body">
                ...
                <form action="<?= base_url('clientes/guardar') ?>" method="POST" autocomplete="off">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select id="tipo_documento" 
                                ...
                                <option value="Cédula" <?= old('tipo_documento') === 'Cédula' ? 'selected' : '' ?>>Cédula de Identidad</option>
                                <option value="Pasaporte" <?= old('tipo_documento') === 'Pasaporte' ? 'selected' : '' ?>>Pasaporte</option>
                                <option value="Otros" <?= old('tipo_documento') === 'Otros' ? 'selected' : '' ?>>Otros / Carnet de Extranjería</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <textarea id="observaciones" 
                                      ...
                                      style="border-radius: var(--radius-md)"><?= old('observaciones') ?></textarea>
                        </div>
                    </div>
